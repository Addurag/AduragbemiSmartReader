  ...
  return (
    <div className="app">
      ...
      <div className="placeholders">
        <button onClick={()=>alert('Read Aloud coming soon (placeholder)')}>馃攰 Read Aloud</button>
        <button onClick={()=>alert('Ask the PDF coming soon (placeholder)')}>馃 Ask the PDF</button>
      </div>
    </div>
  )
}
